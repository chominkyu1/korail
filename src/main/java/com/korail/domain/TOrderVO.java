...
public class TOrderVO {
	...
	public String toString() {
		return "TOrderVO [tOrder_Id=" + tOrder_Id + ", tOrder_Date=" + tOrder_Date + ", tOrder_Price=" + tOrder_Price
				+ ", tOrder_PayType=" + tOrder_PayType + ", tOrder_State=" + tOrder_State + ", member_Id=" + member_Id
				+ "]";
	}
