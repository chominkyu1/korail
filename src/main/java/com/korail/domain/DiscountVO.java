...
public class DiscountVO {
	...
	private String discount_Regidate;
	...
	public DiscountVO(String discount_Id, String station_Id, String discount_Title, String discount_Price,
			String member_Id, String discount_Content, String discount_Shopname, String discount_Shophone,
			String discount_Map, String discount_Regidate, int discount_Count) {
		super();
	...
	public String getDiscount_Regidate() {
		return discount_Regidate;
	}

	public void setDiscount_Regidate(String discount_Regidate) {
		this.discount_Regidate = discount_Regidate;
	}
	...
	public String toString() {
		return "DiscountVO [discount_Id=" + discount_Id + ", station_Id=" + station_Id + ", discount_Title="
				+ discount_Title + ", discount_Price=" + discount_Price + ", member_Id=" + member_Id
				+ ", discount_Content=" + discount_Content + ", discount_Shopname=" + discount_Shopname
				+ ", discount_Shophone=" + discount_Shophone + ", discount_Map=" + discount_Map + ", discount_Regidate="
				+ discount_Regidate + ", discount_Count=" + discount_Count + "]";
	}
